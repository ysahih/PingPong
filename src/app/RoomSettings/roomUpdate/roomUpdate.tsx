        ...
        onSubmit: (value :RoomFormat) => {
            ...
            const updateRoom = async () => {
                ...
                if (!formData.values().next().done) {
                    ...
                    formData.append('name', updateProp.roomName);

                    const response = await axios.post(process.env.NEST_API + '/user/updateRoom', formData,
                    {
                        headers: {
                            'Accept': 'form-data',
                        },
    ...
    return (
        <div className='roomUpdate__wrapper'>
            ...
            <div className="roomUpdate__form--wrapper">
                ...
                <form className="roomUpdate__input--info" onSubmit={formik.handleSubmit}>
                    ...
                    <div className='roomUpdate__inpute--wrapper'>
                        ...
                        <p className="roomUpdate__inpute--error">{formik.touched.name && formik.errors.name ? formik.errors.name : null}</p>
...

                    {
                        ...
                        <div className='roomUpdate__inpute--wrapper'>
                            ...
                            <p className="roomUpdate__inpute--error">{formik.touched.password && formik.errors.password ? formik.errors.password : <></>}</p>
                    ...
                    {update ? <p className="roomUpdate__inpute--update">{update}</p> : <></>}
                    {/* {error ? <p className="roomUpdate__inpute--error">{error}</p> : <p className="roomUpdate__inpute--update">{update}</p>} */}
                    {updating ? <button type="button" className="roomUpdate__btn">Updating...</button> : <button type="submit" className="roomUpdate__btn">Update</button>}
